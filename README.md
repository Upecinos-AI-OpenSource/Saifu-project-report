...
| - | - | - | - |
|TB1|05/09/2024|<p>Comettant Rubiños, Jessica Elizabeth	</p><p>Reyes Valenzuela, Renato German	</p><p>Cisneros Salas,Luis Angel	</p><p>Góngora Sánchez,Marco Antonio	</p><p>Rojas Ccama, Carlos Andres</p>|<p>**Se realizaron los Capítulo I: Introducción** </p><p>Redacción del startup profile y solution profile, delimitación de segmentos objetivo, redacción de preguntas para el diseño de entrevistas</p><p>**Capítulo II: Requirements Elicitation & Analysis**</p><p>Elaboración y registro de entrevistas a segmentos objetivo, análisis de entrevistas</p><p>**Capítulo III: Requirements Specification**</p><p>Elaboración de user stories, product backlog</p><p>Elaboración de user personas, impact mapping, as-is y to-be</p><p>**Capítulo IV: Product Design**</p><p>Elaboración de diagrama de base de datos, diagrama de clases, diccionario de clases, diagramas de contenedores, diagramas de contexto, diagramas de componentes</p><p>Elaboración de prototipos de wireframes y mockups</p><p>Redacción de style guidelines e information architecture</p><p>**Capítulo V: Product Implementation, Validation & Deployment**</p><p>Registro de evidencias y entrega del TB1</p>|
|TP|` `24/09/24|<p>Comettant Rubiños, Jessica Elizabeth	</p><p>Reyes Valenzuela, Renato German	</p><p>Cisneros Salas,Luis Angel	</p><p>Góngora Sánchez,Marco Antonio	</p><p>Rojas Ccama, Carlos Andres</p>|Se realizo el Sprint 2 y la corrección de los cinco capítulos presentes en el informe, de acuerdo con lo indicado en la rúbrica. Además, se añadió el segundo Sprint del proyecto, el cual se enfoca principalmente en el FrontEnd de la aplicación Saifu.|
|TB2|` `01/11/24|<p>Comettant Rubiños, Jessica Elizabeth	</p><p>Reyes Valenzuela, Renato German	</p><p>Cisneros Salas,Luis Angel	</p><p>Góngora Sánchez,Marco Antonio	</p><p>Rojas Ccama, Carlos Andres</p><p></p>|Se realizo el Sprint 3 y la corrección de los cinco capítulos presentes en el informe, de acuerdo con lo indicado en la rúbrica. Se realizaron ajustes en el frontend de la aplicación, se llevaron a cabo las entrevistas de validación y comenzó el desarrollo del backend|
|` `TF|` `19/11/24|<p>Comettant Rubiños, Jessica Elizabeth	</p><p>Reyes Valenzuela, Renato German	</p><p>Cisneros Salas,Luis Angel	</p><p>Góngora Sánchez,Marco Antonio	</p><p>Rojas Ccama, Carlos Andres</p><p></p>|Se realizo el Sprint 4 y la Corrección de los cinco capítulos presentes en el informe, de acuerdo con lo indicado en la rúbrica. Se realizaron los últimos ajustes en el frontend y backend, y se completó el deployment.|
...
| :-: | :-: | :-: |
|Comunicación oralmente con efectividad a diferentes rangos de audiencia.|<p>**TB1:**</p><p>**Comettant Rubiños, Jessica Elizabeth**	</p><p>Diseño de mockups y wireframes, Lean UX Process, Capítulo V, Software Development Environment Configuration, Source Code Management, Style Guide & Conventions, General Style Guidelines, Landing Page Product Backlog.Impact Mapping, registro y análisis de entrevistas, User Task Matrix, As-Is To-be Scenarios, Empathy Mapping, Technical User Stories, User Stories, Product Backlog, Bibliografía.</p><p>**Reyes Valenzuela, Renato German**</p><p>Capítulo I, Diseño de entrevistas, Diagrama de clases, Diagrama de contexto, componentes y contenedores, Information Architecture, User Stories, Diagrama de base de datos.**	</p><p>**Cisneros Salas,Luis Angel**</p><p>Competidores, Análisis competitivo, Estrategias y tácticas frente a competidores, Entrevistas, Diseño de entrevistas.</p><p>**Góngora Sánchez,Marco Antonio**</p><p>Antecedentes y problemática 5W y 2H, Segmentos Objetivos, Análisis de competidores, User Stories, Product Backlog, Conclusiones.</p><p>**Rojas Ccama, Carlos Andres**</p><p>Durante el TB1, me encargué de completar el capítulo 3, el cual se centró en el diseño de la página. En este capítulo, desarrollé los elementos clave del diseño visual y la estructura de la interfaz de usuario.</p><p>**TP:**</p><p>**Comettant Rubiños, Jessica Elizabeth**	</p><p>**Reyes Valenzuela, Renato German**	</p><p>**Cisneros Salas,Luis Angel:**	</p><p>**Góngora Sánchez,Marco Antonio**<br>Realicé el diseño de la página principal, educación financiera y elección de un tema financiero</p><p>**Rojas Ccama, Carlos Andres**</p><p>Durante el TP Implemente el diseño del login y sign up con su API FAKE ya que contribuye de manera significativa a la web application</p><p>**TB2:**</p><p>**Comettant Rubiños, Jessica Elizabeth**	</p><p>**Reyes Valenzuela, Renato German**	</p><p>**Cisneros Salas,Luis Angel**	</p><p>**Góngora Sánchez,Marco Antonio**<br>Implementación de los componentes family y plan tanto en el código cómo en la base de datos.</p><p>**Rojas Ccama, Carlos Andres**</p><p>Me encargué de crear las tablas user\_consults y persons en la base de datos. </p><p>**TF:**</p><p>**Comettant Rubiños, Jessica Elizabeth**	</p><p>**Reyes Valenzuela, Renato German**	</p><p>**Cisneros Salas,Luis Angel:**	</p><p>**Góngora Sánchez,Marco Antonio**</p><p>En esta entrega realicé un orden en la estructura del reporte eliminando  puntos repetidos y asignación de enlaces a cada punto</p><p>**Rojas Ccama, Carlos Andres**</p><p>Durante el TF, estuve trabajando en la finalización del Sprint 4, el cual se centró en el desarrollo del IAM en el backend. Este sprint incluyó la implementación de funcionalidades clave para la gestión de usuarios, autenticación, y autorización dentro de la aplicación.</p>|<p>**TB1:**</p><p>**Comettant Rubiños, Jessica Elizabeth**	</p><p>Concluye que la correcta planificación y el diseño enfocado en el usuario permiten una experiencia fluida y eficiente en el desarrollo de productos digitales, mejorando la usabilidad.</p><p>**TB1**</p><p>**Reyes Valenzuela, Renato German**</p><p>Concluye que la arquitectura sólida y bien definida es fundamental para el éxito del proyecto, ya que facilita la escalabilidad y el mantenimiento de las aplicaciones.</p><p>**TB1**</p><p>**Góngora Sánchez,Marco Antonio**</p><p>Concluye que un buen análisis de competidores y una clara identificación de los segmentos objetivos permiten posicionar el producto de manera efectiva en el mercado.</p><p>**Rojas Ccama, Carlos Andres**</p><p>**TB1:**Concluye que identificar la problemática desde el inicio del proyecto es clave para definir estrategias y soluciones adecuadas a las necesidades del usuario final.</p><p>**Cisneros Salas,Luis Angel**</p><p>**TB1:**Concluye que la recopilación de datos a través de entrevistas bien estructuradas proporciona información valiosa que ayuda a definir mejores estrategias frente a la competencia.</p><p></p><p></p><p></p><p></p><p></p><p></p><p></p><p></p><p></p><p></p><p></p><p>**Rojas Ccama, Carlos Andres**</p><p>**TP**</p><p>Pudimos Implementar la pantalla de login y registro donde los usuarios ingresan sus credenciales para acceder a la aplicación.</p><p>**Góngora Sánchez, Marco Antonio**<br><br>**TP**<br><br>El diseño de la página principal y la elección del tema financiero implicaron comunicar ideas de manera efectiva, asegurando claridad y relevancia para diferentes audiencias cómo los usuarios.</p><p></p><p></p><p></p><p></p><p></p><p></p><p></p><p>**Rojas Ccama, Carlos Andres**</p><p>**TF**</p><p>Pudimos implementar las  funcionalidades clave sobre la gestión de usuarios, autenticación y autorización ya que fue esencial para asegurar que la aplicación cuente con una estructura de seguridad robusta y eficiente. </p><p></p><p>**Góngora Sánchez, Marco Antonio<br><br>TF**<br><br>La organización del reporte, al eliminar puntos repetidos y asignar enlaces claros a cada sección, optimizó su estructura, mejorando la claridad y coherencia del contenido facilitando la comprensión.</p>|
